...
public class ViewImportCustomerOtherVehicle_Activity extends Activity {
    ...
    private EditText edt_state, edt_vehicleno, edt_clientname, edt_vehicleownername, edt_rtoagent, edt_vehicledealer,
            ...
            edt_purcasedate, edt_temregno, edt_remark, edt_hypothecatedto, edt_taxvalidupto, edt_permitvalidupto, edt_satepermitvalidupto, nationalpermitvalidupto, pucrenewaldate, fitnessvalidupto, edt_bank, edt_branch, edt_borrowername,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_import_customer_other_vehicle);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void init() {
        context = ViewImportCustomerOtherVehicle_Activity.this;
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
    ...
    public void viewDocument(View view) {
        ...
        if (Utilities.isInternetAvailable(context)) {
            ...
            new ViewImportCustomerOtherVehicle_Activity.DownloadDocument().execute(edt_selectdocuments.getText().toString().trim());
        } else {
    ...
    private void setUpToolbar() {
        ...
        mToolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (id == R.id.img_edit) {
                    if (Utilities.isInternetAvailable(context)) {
                        new ViewImportCustomerOtherVehicle_Activity.isImportDetails().execute(customerPojo.getId());
                    } else {
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            if (Utilities.isInternetAvailable(context)) {
                                new ViewImportCustomerOtherVehicle_Activity.DeleteCustomerDetails().execute(customerPojo.getId());
                            } else {
                                Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                            }
    ...
    public class isImportDetails extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String res = "[]";
            JsonObject obj = new JsonObject();
            obj.addProperty("type", "isRecoredImportedOther");
            obj.addProperty("id", params[0]);
            res = WebServiceCalls.JSONAPICall(ApplicationConstants.CUSTOMERAPI, obj.toString());
            return res.trim();
        }
