...
public class Import_RTO_Agent_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_import__rto__agent);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void init() {
        context = Import_RTO_Agent_Activity.this;
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
    ...
    private void setEventHandler() {
            ...
            public void onClick(View view) {
                if (statelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_RTO_Agent_Activity.GetStateList().execute(user_id, "2");
                    } else {
        ...
        edt_clientname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clientList.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_RTO_Agent_Activity.GetClientList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_type.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (typelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_RTO_Agent_Activity.GetTypeList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_rtoagent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rtoagentlist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_RTO_Agent_Activity.GetRTOAgentList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_frequency.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (frequencylist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_RTO_Agent_Activity.GetFrqList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
    ...
    private void submitData() {
        ...
        if (Utilities.isInternetAvailable(context)) {
            new Import_RTO_Agent_Activity.AddvehicleDealerDetails().execute(mainObj.toString());
        } else {
            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
        }
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        new Import_RTO_Agent_Activity.IsImport().execute(id);
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (options[item].equals("Take a Photo")) {
                                ...
                                FilePickerBuilder
                                        ...
                                        .pickFile(Import_RTO_Agent_Activity.this);
                            }
                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(Import_RTO_Agent_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(Import_RTO_Agent_Activity.this);
            }
            ...
            if (requestCode == FilePickerConst.REQUEST_CODE_DOC) {
                ...
                new Import_RTO_Agent_Activity.UploadProductPhoto().execute(fileToBeUploaded);
            }
        }
    ...
    void savefile(Uri sourceuri) {
        ...
        new Import_RTO_Agent_Activity.UploadProductPhoto().execute(photoFileToUpload);
