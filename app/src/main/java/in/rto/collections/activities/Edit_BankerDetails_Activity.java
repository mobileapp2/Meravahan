...
public class Edit_BankerDetails_Activity extends Activity {
    ...
    private String user_id, stateId, clientId, typeId,dealerId,statename="",bankId,branchId,frequency,documentId,Id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit__banker_details);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void init() {
        context = Edit_BankerDetails_Activity.this;
    ...
    private void setDefaults() {
        ...
        frequency = bankerDetailsPojo.getFrequency_id();
        dealerId = bankerDetailsPojo.getVehicle_dealer_id();
        clientId = bankerDetailsPojo.getClient_id();
        Id = bankerDetailsPojo.getId();
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
                ...
                documentId = documentsList.get(i).getDocument_id();
            }
        } else {
            ...
            public void onClick(View view) {
                if (clientlist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Edit_BankerDetails_Activity.GetClientList().execute(user_id);
                    } else {
        ...
        edt_frequency.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (frequencylist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Edit_BankerDetails_Activity.GetFrqList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_vehicledealer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (vehicleDealerPojos.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Edit_BankerDetails_Activity.GetVehicleDealerList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
    ...
    private void setUpToolbar() {
        ...
        img_save = findViewById(R.id.img_save);
        mToolbar.setTitle("Edit Loan Details");
    ...
    private void submitData() {
        ...
        for (int i = 0; i < documentsLayoutsList.size(); i++) {
            ...
            if (!((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_selectdocuments)).getText().toString().trim().equals("")) {
                ...
                documentObj.setDoc_name(((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_name)).getText().toString().trim());
        ...
        for (int i = 0; i < documentsList.size(); i++) {
            ...
            documentJSONObj.addProperty("doc_name", documentsList.get(i).getDoc_name());
        ...
        if (Utilities.isInternetAvailable(context)) {
            new Edit_BankerDetails_Activity.updateBankerDetails().execute(mainObj.toString());
        } else {
            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
        }
    ...
    public class updateBankerDetails extends AsyncTask<String, Void, String> {
        ProgressDialog pd;
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        builder.setMessage("Banker Details Updated Successfully.");
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (options[item].equals("Take a Photo")) {
                                ...
                                FilePickerBuilder
                                        ...
                                        .pickFile(Edit_BankerDetails_Activity.this);
                            }
                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(Edit_BankerDetails_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(Edit_BankerDetails_Activity.this);
            }
            ...
            if (requestCode == FilePickerConst.REQUEST_CODE_DOC) {
                ...
                new Edit_BankerDetails_Activity.UploadProductPhoto().execute(fileToBeUploaded);
            }
        }
    ...
    void savefile(Uri sourceuri) {
        ...
        new Edit_BankerDetails_Activity.UploadProductPhoto().execute(photoFileToUpload);
