...
public class Import_Banker_Dealer_Activity extends Activity {
    ...
    private String user_id, stateId, clientId, typeId,rtoId,id,serviceDateId,otherDateId,statename="",createdId,frequency;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_import__banker__dealer);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void init() {
        context = Import_Banker_Dealer_Activity.this;
        ...
        vehicledealerPicFolder = new File(Environment.getExternalStorageDirectory() + "/RTO/" + "VehicleDealer");
    ...
    private void setDefaults() {
        if (Utilities.isInternetAvailable(context)) {
            new Import_Banker_Dealer_Activity.GetstateName().execute(user_id);
        } else {
...
//        edt_renewaldate.setText(changeDateFormat("dd-MM-yyyy",
        //   "dd/MM/yyyy",
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
    ...
    private void setEventHandler() {
            ...
            public void onClick(View view) {
                if (statelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_Banker_Dealer_Activity.GetStateList().execute(user_id, "2");
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_clientname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clientList.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_Banker_Dealer_Activity.GetClientList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_type.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (typelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_Banker_Dealer_Activity.GetTypeList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_rtoagent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (rtoagentlist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_Banker_Dealer_Activity.GetRTOAgentList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_frequency.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (frequencylist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_Banker_Dealer_Activity.GetFrqList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
    ...
    private void submitData() {
        ...
        if (Utilities.isInternetAvailable(context)) {
            new Import_Banker_Dealer_Activity.AddvehicleDealerDetails().execute(mainObj.toString());
        } else {
            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
        }
    ...
    public class AddvehicleDealerDetails extends AsyncTask<String, Void, String> {
        ProgressDialog pd;
        ...
        protected String doInBackground(String... params) {
            String res = "[]";
            res = WebServiceCalls.JSONAPICall(ApplicationConstants.VEHICLEDEALER, params[0]);
            return res.trim();
        }
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        new Import_Banker_Dealer_Activity.IsImport().execute(id);
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (options[item].equals("Take a Photo")) {
                                ...
                                FilePickerBuilder
                                        ...
                                        .pickFile(Import_Banker_Dealer_Activity.this);
                            }
                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(Import_Banker_Dealer_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(Import_Banker_Dealer_Activity.this);
            }
            ...
            if (requestCode == FilePickerConst.REQUEST_CODE_DOC) {
                ...
                new Import_Banker_Dealer_Activity.UploadProductPhoto().execute(fileToBeUploaded);
            }
        }
    ...
    void savefile(Uri sourceuri) {
        ...
        String destinationFilename = Environment.getExternalStorageDirectory() + "/RTO/"
                + "/VehicleDealer/" + File.separatorChar + "img.png";
        ...
        new Import_Banker_Dealer_Activity.UploadProductPhoto().execute(photoFileToUpload);
