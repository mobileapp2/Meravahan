...
public class EditTyre_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_tyre);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void init() {
        context = EditTyre_Activity.this;
    ...
    private void setDefaults() {
        ...
        id = tyreDetailsPojo.getId();
        stateId = tyreDetailsPojo.getStateId();
        clientId = tyreDetailsPojo.getClient_id();
        typeId = tyreDetailsPojo.getType_id();
       // otherId = tyreDetailsPojo.getOther_date();
        edt_clientname.setText(tyreDetailsPojo.getClient_name());
        edt_state.setText(tyreDetailsPojo.getStateName());
        edt_description.setText(tyreDetailsPojo.getDescription());
        edt_purchasedate.setText(changeDateFormat("yyyy-MM-dd",
                "dd/MM/yyyy", tyreDetailsPojo.getPurchase_date()));
        edt_remouning.setText(changeDateFormat("yyyy-MM-dd",
                "dd/MM/yyyy",
                tyreDetailsPojo.getTyre_remounding_date()));
        edt_replacementdate.setText(changeDateFormat("yyyy-MM-dd",
                "dd/MM/yyyy", tyreDetailsPojo.getTyre_replacement_date()));

        edt_remark.setText(tyreDetailsPojo.getRemark());
        edt_type.setText(tyreDetailsPojo.getType_name());
        edt_description.setText(tyreDetailsPojo.getDescription());
        edt_vehicleno.setText(tyreDetailsPojo.getVehicle_no());
        edt_tyreno.setText(tyreDetailsPojo.getTyre_no());

        ArrayList<TyreDetailsPojo.OtherDatesListPojo> otherDatesList = new ArrayList<>();
        otherDatesList = tyreDetailsPojo.getOther_date();
        ...
        documentsList = tyreDetailsPojo.getDocument();
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
    ...
    private void setEventHandler() {
            ...
            public void onClick(View view) {
                if (statelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new EditTyre_Activity.GetStateList().execute(user_id, "2");
                    } else {
        ...
        edt_clientname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clientList.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new EditTyre_Activity.GetClientList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_type.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (typelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new EditTyre_Activity.GetTypeList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
    ...
    private void setUpToolbar() {
        ...
        mToolbar.setTitle("Edit Tyre Details");
    ...
    private void submitData() {
        ...
        if (Utilities.isInternetAvailable(context)) {
            new EditTyre_Activity.UpdateTyreDetails().execute(mainObj.toString());
        } else {
            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
        }
    ...
    public class UpdateTyreDetails extends AsyncTask<String, Void, String> {
        ProgressDialog pd;
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        builder.setMessage("Tyre Details Updated Successfully");
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (options[item].equals("Take a Photo")) {
                                ...
                                FilePickerBuilder
                                        ...
                                        .pickFile(EditTyre_Activity.this);
                            }
                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(EditTyre_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(EditTyre_Activity.this);
            }
            ...
            if (requestCode == FilePickerConst.REQUEST_CODE_DOC) {
                ...
                new EditTyre_Activity.UploadProductPhoto().execute(fileToBeUploaded);
            }
        }
    ...
    void savefile(Uri sourceuri) {
        ...
        new EditTyre_Activity.UploadProductPhoto().execute(photoFileToUpload);
