...
public class ViewTyre_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_tyre);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void init() {
        context = ViewTyre_Activity.this;
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
    ...
    public void viewDocument(View view) {
        ...
        if (Utilities.isInternetAvailable(context)) {
            ...
            new ViewTyre_Activity.DownloadDocument().execute(edt_selectdocuments.getText().toString().trim());
        } else {
                ...
                if(id == R.id.img_edit){
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            if (Utilities.isInternetAvailable(context)) {
                                new ViewTyre_Activity.DeletetyreDetails().execute(tyreDetailsPojo.getId());
                            } else {
    ...
    public class DownloadDocument extends AsyncTask<String, Integer, Boolean> {
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try {
                ...
                file = new File(tyrePicFolder, Uri.parse(params[0]).getLastPathSegment());
    ...
    public class DeletetyreDetails extends AsyncTask<String, Void, String> {
        ProgressDialog pd;
        ...
        protected String doInBackground(String... params) {
            ...
            res = WebServiceCalls.JSONAPICall(ApplicationConstants.TYREAPI, obj.toString());
            return res.trim();
        }
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.CustomDialogTheme);
                        builder.setMessage("RTO Agent Details Deleted Successfully");
