...
public class ViewRTOAgent_Activity extends Activity {
    ...
    private void init() {
        context = ViewRTOAgent_Activity.this;
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
                ...
                final ArrayList<RTOAgentListPojo.DocumentListPojo> finalDocumentsList = documentsList;
                final int finalI = i;
                    ...
                    if (id == R.id.img_edit) {
                        ...
                        builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int id) {
                                ...
                                if (Utilities.isInternetAvailable(context)) {
                                    new DeleteRTOAgentDetails().execute(rtoAgentListPojo.getId());
                                } else {
