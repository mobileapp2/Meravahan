...
public class AddRTOAgent_Activity extends Activity {
    ...
    private EditText edt_state, edt_vehicleno, edt_clientname, edt_vehicleownername, edt_vehicledealer,
            ...
            pucrenewaldate,fitnessvalidupto;
    ...
    private String isshowtocustomer , isshowtorto,documentType;

    private EditText edt_selectdocuments = null,edt_name = null,edt_selectVehicleImage;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_rtoagent);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void init() {
        context = AddRTOAgent_Activity.this;
    ...
    private void setDefaults() {
        if (Utilities.isInternetAvailable(context)) {
            new AddRTOAgent_Activity.GetstateName().execute(user_id);
        } else {
    ...
    private void setEventHandler() {
            ...
            public void onClick(View view) {
                if (statelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new AddRTOAgent_Activity.GetStateList().execute(user_id, "2");
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_clientname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clientList.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new AddRTOAgent_Activity.GetClientList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_type.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (typelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new AddRTOAgent_Activity.GetTypeList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_vehicledealer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (vehicleDealerPojos.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new AddRTOAgent_Activity.GetVehicleDealerList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
    ...
    private void setUpToolbar() {
        ...
        mToolbar.setTitle("Add Vehicle Details");
    ...
    private void submitData() {
        ...
        if (Utilities.isInternetAvailable(context)) {
            new AddRTOAgent_Activity.AddrtoagentDetails().execute(mainObj.toString());
        } else {
            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
        }
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        builder.setMessage("Vehicle Details Saved Successfully.");
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (options[item].equals("Take a Photo")) {
                                ...
                                FilePickerBuilder
                                        ...
                                        .pickFile(AddRTOAgent_Activity.this);
                            }
                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(AddRTOAgent_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(AddRTOAgent_Activity.this);
            }
            ...
            if (requestCode == FilePickerConst.REQUEST_CODE_DOC) {
                ...
                new AddRTOAgent_Activity.UploadProductPhoto().execute(fileToBeUploaded);
            }
        }
    ...
    void savefile(Uri sourceuri) {
        ...
        new AddRTOAgent_Activity.UploadProductPhoto().execute(photoFileToUpload);
