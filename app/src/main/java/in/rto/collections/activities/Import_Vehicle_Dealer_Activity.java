...
public class Import_Vehicle_Dealer_Activity extends Activity {
    ...
    private String user_id, stateId, clientId, typeId, dealerId, id, statename = "", createdId;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_import__vehicle__dealer);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void init() {
        context = Import_Vehicle_Dealer_Activity.this;
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
    ...
    private void setEventHandler() {
            ...
            public void onClick(View view) {
                if (statelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_Vehicle_Dealer_Activity.GetStateList().execute(user_id, "2");
                    } else {
        ...
        edt_clientname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clientList.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_Vehicle_Dealer_Activity.GetClientList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_type.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (typelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_Vehicle_Dealer_Activity.GetTypeList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_vehicledealer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (vehicleDealerPojos.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Import_Vehicle_Dealer_Activity.GetVehicleDealerList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
    ...
    private void submitData() {
        ...
        if (Utilities.isInternetAvailable(context)) {
            new Import_Vehicle_Dealer_Activity.AddrtoagentDetails().execute(mainObj.toString());
        } else {
            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
        }
    ...
    public class AddrtoagentDetails extends AsyncTask<String, Void, String> {
        ProgressDialog pd;
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    type = mainObj.getString("type");
                    message = mainObj.getString("message");
                    result1 = mainObj.getString("result");
                    if (type.equalsIgnoreCase("success")) {
                        new Import_Vehicle_Dealer_Activity.IsImport().execute(id);
                        //new Fragment_RTO_Agent.GetRTOAgentList().execute(result);
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (options[item].equals("Take a Photo")) {
                                ...
                                FilePickerBuilder
                                        ...
                                        .pickFile(Import_Vehicle_Dealer_Activity.this);
                            }
                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(Import_Vehicle_Dealer_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(Import_Vehicle_Dealer_Activity.this);
            }
            ...
            if (requestCode == FilePickerConst.REQUEST_CODE_DOC) {
                ...
                new Import_Vehicle_Dealer_Activity.UploadProductPhoto().execute(fileToBeUploaded);
            }
        }
    ...
    void savefile(Uri sourceuri) {
        ...
        new Import_Vehicle_Dealer_Activity.UploadProductPhoto().execute(photoFileToUpload);
