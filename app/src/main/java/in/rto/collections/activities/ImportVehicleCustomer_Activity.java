...
public class ImportVehicleCustomer_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_import_vehicle_customer);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
    ...
    private void setEventHandler() {
            ...
            public void onClick(View view) {
                if (statelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new ImportVehicleCustomer_Activity.GetStateList().execute(user_id, "2");
                    } else {
        ...
        edt_type.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (typelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new ImportVehicleCustomer_Activity.GetTypeList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_frequency.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (frequencylist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new ImportVehicleCustomer_Activity.GetFrqList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
    ...
    private void submitData() {
        ...
        if (Utilities.isInternetAvailable(context)) {
            new ImportVehicleCustomer_Activity.AddCustomerDetails().execute(mainObj.toString());
        } else {
            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
        }
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    message = mainObj.getString("message");
                    if (type.equalsIgnoreCase("success")) {
                        new ImportVehicleCustomer_Activity.IsImport().execute(id);
                    } else {
                        ...
                        public void onClick(DialogInterface dialog, int item) {
                            if (options[item].equals("Take a Photo")) {
                                ...
                                FilePickerBuilder
                                        ...
                                        .pickFile(ImportVehicleCustomer_Activity.this);
                            }
                        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(ImportVehicleCustomer_Activity.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(ImportVehicleCustomer_Activity.this);
            }
            ...
            if (requestCode == FilePickerConst.REQUEST_CODE_DOC) {
                ...
                new ImportVehicleCustomer_Activity.UploadProductPhoto().execute(fileToBeUploaded);
            }
        }
    ...
    void savefile(Uri sourceuri) {
        ...
        new ImportVehicleCustomer_Activity.UploadProductPhoto().execute(photoFileToUpload);
//        doc_image_uri = Uri.fromFile(imageFile);
    ...
    public class IsImport extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            obj.addProperty("type", "isImportDealer");
