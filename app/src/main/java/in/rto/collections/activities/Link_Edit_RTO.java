...
public class Link_Edit_RTO extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_link__edit__rto);
        init();
        getSessionData();
        setDefaults();
        setUpToolbar();
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
                    ((EditText) documentsLayoutsList1.get(i).findViewById(R.id.edt_selectdocuments)).setText(documentsList1.get(i).getDocument_name());
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
                    ...
                    ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_name)).setText(documentsList2.get(i).getName());
                }
            } else {
    ...
    private void setEventHandler() {
            ...
            public void onClick(View view) {
                if (statelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Link_Edit_RTO.GetStateList().execute(user_id, "2");
                    } else {
        ...
        edt_clientname.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (clientList.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Link_Edit_RTO.GetClientList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_type.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (typelist.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Link_Edit_RTO.GetTypeList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
        ...
        edt_vehicledealer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (vehicleDealerPojos.size() == 0) {
                    if (Utilities.isNetworkAvailable(context)) {
                        new Link_Edit_RTO.GetVehicleDealerList().execute(user_id);
                    } else {
                        Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                    }
                } else {
    ...
    private void submitData() {
        ...
        if (documentsLayoutsList1.size() != 0) {
            ...
            for (int i = 0; i < documentsList1.size(); i++) {
                ...
                documentJSONObj.addProperty("doc_name", documentsList1.get(i).getDocument_name());
        ...
        mainObj.addProperty("type", "linkvehicleTorto");
        ...
        mainObj.addProperty("dealercreatedby", vehiclecreatedby);
        ...
        if (Utilities.isInternetAvailable(context)) {
            new Link_Edit_RTO.UpdateRTOAgentDetails().execute(mainObj.toString());
        } else {
            Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
        }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (requestCode == GALLERY_REQUEST) {
                ...
                CropImage.activity(imageUri).setGuidelines(CropImageView.Guidelines.ON).start(Link_Edit_RTO.this);
            }
            if (requestCode == CAMERA_REQUEST) {
                CropImage.activity(photoURI).setGuidelines(CropImageView.Guidelines.ON).start(Link_Edit_RTO.this);
            }
            ...
            if (requestCode == FilePickerConst.REQUEST_CODE_DOC) {
                ...
                new Link_Edit_RTO.UploadProductPhoto().execute(fileToBeUploaded);
            }
        }
    ...
    void savefile(Uri sourceuri) {
        ...
        new Link_Edit_RTO.UploadProductPhoto().execute(photoFileToUpload);
