...
public class ViewImportRTOCustomer_Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_import_rtocustomer);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void setDefaults() {
        ...
        edt_insurancepolicyno.setText(customerPojo.getVehicle_no());
...
//                ((EditText) documentsLayoutsList.get(i).findViewById(R.id.edt_documentname)).setText(document_name);
    ...
    public void viewDocument(View view) {
        ...
        if (Utilities.isInternetAvailable(context)) {
            ...
            new ViewImportRTOCustomer_Activity.DownloadDocument().execute(edt_selectdocuments.getText().toString().trim());
        } else {
                ...
                if(id == R.id.img_edit){
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            if (Utilities.isInternetAvailable(context)) {
                                new ViewImportRTOCustomer_Activity.DeleteCustomerDetails().execute(customerPojo.getId());
                            } else {
                                Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                            }
            ...
            try {
                ...
                if (!result.equals("")) {
                    ...
                    if (type.equalsIgnoreCase("success")) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.CustomDialogTheme);
                        builder.setMessage("Import Details Deleted Successfully");
    ...
    public class isImportDetails extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String res = "[]";
            JsonObject obj = new JsonObject();
            obj.addProperty("type", "isRecoredImportedRTO");
            obj.addProperty("id", params[0]);
            res = WebServiceCalls.JSONAPICall(ApplicationConstants.CUSTOMERAPI, obj.toString());
            return res.trim();
        }
