...
public class ViewImportDealerBanker_Activity extends Activity {
    ...
    private VehicleDealerListPojo vehicleDealerListPojo;
    private ImageView img_delete, img_edit;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_import_dealer_banker);
        init();
        setUpToolbar();
        getSessionData();
        setDefaults();
    ...
    private void init() {
        context = ViewImportDealerBanker_Activity.this;
    ...
    private void setDefaults() {
        ...
        vehicleDealerListPojo = (VehicleDealerListPojo) getIntent().getSerializableExtra("bankerdetails");
        edt_bank.setText(vehicleDealerListPojo.getBank_name());
        edt_branch.setText(vehicleDealerListPojo.getBranch_name());
        edt_description.setText(vehicleDealerListPojo.getDescription());
        edt_sactiondate.setText(changeDateFormat("yyyy-MM-dd",
                "dd/MM/yyyy", vehicleDealerListPojo.getDate_to_section()));
        edt_enddate.setText(changeDateFormat("yyyy-MM-dd",
                "dd/MM/yyyy",
                vehicleDealerListPojo.getInstallment_end_date()));
        edt_startdate.setText(changeDateFormat("yyyy-MM-dd",
                "dd/MM/yyyy",
                vehicleDealerListPojo.getInstallment_start_date()));

        purchasedate.setText(changeDateFormat("yyyy-MM-dd",
                "dd/MM/yyyy", vehicleDealerListPojo.getPurchase_date()));

        edt_loanamount.setText(vehicleDealerListPojo.getLoan_amount());
        edt_accountnumber.setText(vehicleDealerListPojo.getLoan_account_number());
        edt_installmentanount.setText(vehicleDealerListPojo.getInstallment_amount());
        edt_remark.setText(vehicleDealerListPojo.getRemark());
        // edt_clientname.setText(customerPojo.getClient_name());
        edt_frequency.setText(vehicleDealerListPojo.getFrequency());
        edt_borrowername.setText(vehicleDealerListPojo.getBorrower_name());
        edt_description.setText(vehicleDealerListPojo.getDescription());
        edt_vehiclenumber.setText(vehicleDealerListPojo.getVehicle_no());
        edt_selectVehicleImage.setText(vehicleDealerListPojo.getVehicle_image());

        ArrayList<VehicleDealerListPojo.DocumentListPojo> documentsList = new ArrayList<>();
        documentsList = vehicleDealerListPojo.getDocument();
            ...
            public boolean onMenuItemClick(MenuItem item) {
                ...
                if (id == R.id.img_edit) {
                    if (Utilities.isInternetAvailable(context)) {
                        if (Utilities.isInternetAvailable(context)) {
                            new ViewImportDealerBanker_Activity.isImportDetails().execute(vehicleDealerListPojo.getId());
                        } else {
                    ...
                    builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            if (Utilities.isInternetAvailable(context)) {
                                new ViewImportDealerBanker_Activity.DeleteBankerDetails().execute(vehicleDealerListPojo.getId());
                            } else {
                                Utilities.showSnackBar(ll_parent, "Please Check Internet Connection");
                            }
