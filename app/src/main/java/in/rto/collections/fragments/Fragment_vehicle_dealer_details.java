...
public class Fragment_vehicle_dealer_details extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_vehicle_dealer_details, container, false);
        context = getActivity();
        init(rootView);
        setDefault();
        setEventListner();
...
//tabLayout.setBackgroundColor(getResources().getColor(R.color.black));
    ...
    private void setupViewPager(ViewPager viewPager) {
        Fragment_vehicle_dealer_details.ViewPagerAdapter adapter = new Fragment_vehicle_dealer_details.ViewPagerAdapter(getChildFragmentManager());
        adapter.addFrag(new Fragment_vehicle_dealer(), "OWN");
        adapter.addFrag(new Fragment_vehical_rto_details(), "IMPORT");
