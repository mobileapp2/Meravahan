...
public class Fragment_RTO_Agent_Details extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_fragment__rto__agent__details, container, false);
        context = getActivity();
        init(rootView);
        setDefault();
        setEventListner();
...
//        tabLayout.getTabAt(2).setIcon(R.drawable.icon_premium);
    ...
    private void setupViewPager(ViewPager viewPager) {
        Fragment_RTO_Agent_Details.ViewPagerAdapter adapter = new Fragment_RTO_Agent_Details.ViewPagerAdapter(getChildFragmentManager());
        adapter.addFrag(new Fragment_RTO_Agent(), "OWN");
        adapter.addFrag(new Fragment_RTO_Dealer_Details(), "IMPORT");
