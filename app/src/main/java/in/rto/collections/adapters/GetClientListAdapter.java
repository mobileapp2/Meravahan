...
import in.rto.collections.activities.ViewClientDetails_Activity;
...
public class GetClientListAdapter extends RecyclerView.Adapter<GetClientListAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        ...
        holder.tv_clientname.setText(clientDetails.getName());
        ...
        holder.imv_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ActivityCompat.checkSelfPermission(context, Manifest.permission.CALL_PHONE)
                    ...
                    alertDialogBuilder.setMessage("Are you sure you want to call " + finalClientDetails.getName() + " ?");
