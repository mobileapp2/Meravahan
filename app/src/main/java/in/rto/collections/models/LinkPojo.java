...
public class LinkPojo implements Serializable {
    ...
    private ArrayList<LinkPojo.ServiceDatesListPojo> service_date;
    private ArrayList<LinkPojo.OtherDatesListPojo> other_date;

    private ArrayList<LinkPojo.DocumentListPojo> document;
    ...
    public ArrayList<LinkPojo.ServiceDatesListPojo> getService_date() {
        return service_date;
    }
    ...
    public void setOther_date(ArrayList<LinkPojo.OtherDatesListPojo> other_date) {
        this.other_date = other_date;
    }

    public ArrayList<LinkPojo.DocumentListPojo> getDocument() {
        return document;
    }

    public void setDocument(ArrayList<LinkPojo.DocumentListPojo> document) {
